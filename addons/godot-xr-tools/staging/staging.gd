...
func set_volumes_on_load():
	AudioServer.set_bus_volume_db(waterBusIndex, linear_to_db(Globals.fx_vol))
	AudioServer.set_bus_volume_db(pigsBusIndex, linear_to_db(Globals.fx_vol))
	AudioServer.set_bus_volume_db(noWaterFxIndex, linear_to_db(Globals.fx_vol))
	AudioServer.set_bus_volume_db(musicBusIndex, linear_to_db(Globals.music_vol))
	AudioServer.set_bus_volume_db(masterBusIndex, linear_to_db(Globals.master_vol))
